...
class REST_Controller extends CI_Controller {
	...
	protected $session_csrf = NULL; //contain csrf value
	...
	public function check_csrf(){
        ...
        $session = $this->session->userdata('csrfSecret');

        if ($session == $headerCsrf) return true;
        return false;
	}
	 ...
	 * parameter get
	 *
	 * take parameter with get method, check if error return 404
	 */
	public function paramsget($data = array(), $http_code = null)
	{
		// If data is empty and not code provide, error and bail
		if (empty($data) && $http_code === null)
    	{
